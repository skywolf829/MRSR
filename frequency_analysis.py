...
parser.add_argument('--GT',default="isomag2D_compressiontest.nc")
parser.add_argument('--NN',default="isomag2D_compressiontest_NN.nc")
parser.add_argument('--octree',default="isomag2D_compressiontest_NN_octree.nc")
parser.add_argument('--SZ',default="isomag2D_compressiontest_SZ.nc")
