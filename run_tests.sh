...
#python3 test_SSR.py --output_file_name Isomag2D_2x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_allTrainingData --scale_factor 2 --testing_method model --model_name Isomag2D --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
#python3 test_SSR.py --output_file_name Isomag2D_2x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_70percent --scale_factor 2 --testing_method model --model_name Isomag2D_70percent --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
...
#python3 test_SSR.py --output_file_name Isomag2D_2x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_30percent --scale_factor 2 --testing_method model --model_name Isomag2D_30percent --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
#python3 test_SSR.py --output_file_name Isomag2D_2x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_10percent --scale_factor 2 --testing_method model --model_name Isomag2D_10percent --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
#python3 test_SSR.py --output_file_name Isomag2D_2x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_2percent --scale_factor 2 --testing_method model --model_name Isomag2D_8items --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
...
python3 test_SSR.py --output_file_name Isomag2D_4x_trainingdatatest --full_resolution 1024 --channels 1 --save_name model_2percent --scale_factor 4 --testing_method model --model_name Isomag2D_8items --print True --device cuda:0 --data_folder Isomag2D --mode 2D 
