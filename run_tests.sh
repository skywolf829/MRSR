...
python3 test_SSR.py --output_file_name --full_resolution 512 --channels 1 mixing_p_3D_2x --save_name mixing3D --scale_factor 2 --testing_method model --print True --device cuda:0 --parallel True --data_folder mix_p --mode 3D 
