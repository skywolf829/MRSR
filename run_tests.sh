...
python3 test_SSR.py --output_file_name mixing_p_3D_2x --full_resolution 512 --channels 1 --save_name mixing3D --scale_factor 2 --testing_method model --print True --device cuda:0 --parallel True --data_folder iso1024mag --mode 3D 
