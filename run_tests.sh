...
python3 test_SSR.py --output_file_name isomag3D_2x --save_name isomag3D --scale_factor 2 --testing_method model --print True --device cuda:0 --parallel True --data_folder iso1024mag --mode 3D 
