...
# 3D mixing dataset
python3 mixedLOD_octree.py --save_name "NN_trilinearheuristic_mixedLOD_octree_SZ" --downscaling_technique avgpool3D --upscaling_technique model --model_name SSR_mixing_p --criterion psnr --start_metric 20 --end_metric 55 --metric_skip 0.5 --output_folder mixing3D_compression --mode 3D --file mixing3D_compressiontest.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --compressor sz --load_existing false --debug true --device cuda:0 --interpolation_heuristic true 
python3 sz_test.py --metric psnr --channels 1 --file mixing3D_compressiontest.h5 --start_value 20 --end_value 55 --value_skip .5 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression
