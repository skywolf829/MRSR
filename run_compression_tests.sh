...
#python3 -u sz_test.py --metric psnr --channels 1 --file isomag3D_compressiontest.h5 --start_value 1 --end_value 55 --value_skip 3 --dims 3 --nx 1024 --ny 1024 --nz 1024 --output_folder isomag3D_compression
