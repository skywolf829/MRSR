...
python3 sz_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_value 30 --end_value 55 --value_skip .5 --dims 2 --nx 1024 --ny 1024 --output_folder mag2D_compression
python3 zfp_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_bpv 0.25 --end_bpv 4 --bpv_skip 0.25 --dims 2 --nx 1024 --ny 1024 --output_folder mag2D_compression
