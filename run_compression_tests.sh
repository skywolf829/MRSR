...
python3 -u sz_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_value 30 --end_value 55 --value_skip .5 --dims 2 --nx 1024 --ny 1024 --output_folder mag2D_compression
...
#python3 -u sz_test.py --metric psnr --channels 1 --file mixing3D_compressiontest.h5 --start_value 30 --end_value 55 --value_skip .5 --dims 3 --nx 128 --ny 128 --nz 128 --output_folder mixing3D_compression
