...
# 3D mixing dataset
python3 -u mixedLOD_octree.py --save_name NN_SZ --downscaling_technique avgpool3D --upscaling_technique model --model_name SSR_mixing_p --criterion psnr --start_metric 35 --end_metric 55 --metric_skip 0.5 --output_folder mixing3D_compression_test --max_LOD 5 --min_chunk 16 --mode 3D --file mixing3D_compressiontest.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --distributed true --compressor sz --load_existing false --save_netcdf false --debug false --preupscaling_PSNR false --device cuda:0 --dynamic_downscaling true --interpolation_heuristic true 
python3 -u sz_test.py --metric mre --channels 1 --file mixing3D_compressiontest.h5 --start_value 0.005 --end_value 0.9 --value_skip .005 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression_test --save_netcdf true
