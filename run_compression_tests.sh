...
python3 -u sz_test.py --metric mre --channels 1 --file isomag2D_compressiontest.h5 --start_value 0.01 --end_value 0.3 --value_skip .01 --dims 2 --nx 1024 --ny 1024 --save_TKE false --output_folder mag2D_compression_test2 --save_netcdf false
