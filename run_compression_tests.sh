...
python3 mixedLOD_octree.py --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 20 --end_metric 80 --metric_skip 5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing true --debug true --device cuda:0 
python3 mixedLOD_octree.py --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 20 --end_metric 80 --metric_skip 5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing true --debug true --device cuda:1 --dynamic_downscaling false
