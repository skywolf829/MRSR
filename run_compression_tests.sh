...
#python3 mixedLOD_octree.py --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D_1blocks_96kernels --criterion psnr --start_metric 20 --end_metric 80 --metric_skip 5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing false --debug true --device cuda:0 
#python3 mixedLOD_octree.py --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D_1blocks_96kernels --criterion psnr --start_metric 20 --end_metric 80 --metric_skip 5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing false --debug true --device cuda:1 --dynamic_downscaling false
...
python3 zfp_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_bpv 0.5 --end_bpv 16 --bpv_skip 0.5 --dims 1 --nx 1024 --ny 1024 --output_folder mag2D_compression
