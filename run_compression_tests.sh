...
#python3 -u sz_test.py --metric mre --channels 1 --file isomag3D_compressiontest.h5 --start_value 0.05 --end_value 0.95 --value_skip 0.05 --dims 3 --nx 1024 --ny 1024 --nz 1024 --output_folder mag3D_compression_test --save_TKE false --save_netcdf false
