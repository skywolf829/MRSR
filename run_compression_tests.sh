...
#python3 -u mixedLOD_octree.py --save_name NN_SZ_zerosubstrate --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 35 --end_metric 35.1 --metric_skip 0.5 --output_folder mag2D_compression_test --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing true --save_TKE true --debug true --device cuda:0 --interpolation_heuristic true --save_netcdf true --dynamic_downscaling true --preupscaling_PSNR true
...
#python3 -u sz_test.py --metric mre --channels 1 --file isomag2D_compressiontest.h5 --start_value 0.07 --end_value 0.071 --value_skip .01 --dims 2 --nx 1024 --ny 1024 --save_TKE false --output_folder mag2D_compression_test --save_netcdf true
...
python3 -u sz_test.py --metric mre --channels 1 --file isomag3D_compressiontest.h5 --start_value 0.001 --end_value 0.01 --value_skip 0.02 --dims 3 --nx 1024 --ny 1024 --nz 1024 --output_folder mag3D_compression_test --save_TKE false --save_netcdf false

# 3D mixing dataset
#python3 -u mixedLOD_octree.py --save_name NN_SZ --downscaling_technique avgpool3D --upscaling_technique model --model_name SSR_mixing_p --criterion psnr --start_metric 28 --end_metric 35 --metric_skip 0.5 --output_folder mixing3D_compression --max_LOD 5 --min_chunk 16 --mode 3D --file mixing3D_compressiontest.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --distributed true --compressor sz --load_existing false --save_netcdf false --debug false --preupscaling_PSNR true --device cuda:0 --dynamic_downscaling false --interpolation_heuristic true 
#python3 -u sz_test.py --metric mre --channels 1 --file mixing3D_compressiontest.h5 --start_value 0.175 --end_value 0.1751 --value_skip .01 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression --save_netcdf true
