...
python3 -u sz_test.py --metric mre --channels 1 --file isomag2D_compressiontest.h5 --start_value 0.001 --end_value 0.01 --value_skip .002 --dims 2 --nx 1024 --ny 1024 --save_TKE false --output_folder mag2D_compression_test2 --save_netcdf false
