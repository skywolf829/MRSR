...
#python3 -u sz_test.py --metric mre --channels 1 --file isomag3D_compressiontest.h5 --start_value 0.6 --end_value 0.99 --value_skip 0.1 --dims 3 --nx 1024 --ny 1024 --nz 1024 --output_folder mag3D_compression --save_TKE true
...
#python3 -u sz_test.py --metric mre --channels 1 --file mixing3D_compressiontest.h5 --start_value 0.005 --end_value 0.4 --value_skip .01 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression --save_netcdf false
