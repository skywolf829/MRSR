...
# 3D mixing dataset
python3 -u mixedLOD_octree.py --save_name NN_trilinearheuristic_SR_octree_SZ --downscaling_technique avgpool3D --upscaling_technique model --model_name SSR_mixing_p --criterion psnr --start_metric 34 --end_metric 55 --metric_skip 0.5 --output_folder mixing3D_compression --max_LOD 5 --min_chunk 16 --mode 3D --file mixing3D_compressiontest.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --distributed true --compressor sz --load_existing false --save_netcdf false --debug true --device cuda:0 --dynamic_downscaling true --interpolation_heuristic true 
