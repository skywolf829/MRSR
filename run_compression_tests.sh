...
#python3 -u sz_test.py --metric mre --channels 1 --file isomag2D_compressiontest.h5 --start_value 0.08 --end_value 0.2 --value_skip .01 --dims 2 --nx 1024 --ny 1024 --save_TKE true --output_folder mag2D_compression_test
