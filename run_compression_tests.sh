...
python3 mixedLOD_octree.py --save_name "NN - mixed-LOD octree - SZ" --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 30 --end_metric 55 --metric_skip .5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing false --debug true --device cuda:0 
python3 mixedLOD_octree.py --save_name "NN - SZ" --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 30 --end_metric 55 --metric_skip .5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing false --device cuda:1 --dynamic_downscaling false 
python3 mixedLOD_octree.py --save_name "NN - bilinear heuristic - mixed-LOD octree - SZ" --downscaling_technique avgpool2D --upscaling_technique model --model_name SSR_isomag2D --criterion psnr --start_metric 30 --end_metric 55 --metric_skip .5 --output_folder mag2D_compression --mode 2D --file isomag2D_compressiontest.h5 --dims 2 --nx 1024 --ny 1024 --use_compressor true --compressor sz --load_existing false --debug true --device cuda:0 --interpolation_heuristic true 
...
python3 sz_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_value 20 --end_value 80 --value_skip .5 --dims 2 --nx 1024 --ny 1024 --output_folder mag2D_compression
#python3 zfp_test.py --metric psnr --channels 1 --file isomag2D_compressiontest.h5 --start_bpv 0.5 --end_bpv 16 --bpv_skip 0.5 --dims 2 --nx 1024 --ny 1024 --output_folder mag2D_compression
