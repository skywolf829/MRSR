...
python3 -u sz_test.py --metric psnr --channels 1 --file mixing3D_compressiontest.h5 --start_value 20 --end_value 55 --value_skip .5 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression
