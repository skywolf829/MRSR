...
python3 -u sz_test.py --metric mre --channels 1 --file mixing3D_compressiontest.h5 --start_value 0.5 --end_value 1.0 --value_skip .05 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression
