...
python3 -u sz_test.py --metric mre --channels 1 --file isomag3D_compressiontest.h5 --start_value 0.003 --end_value 0.01 --value_skip 0.02 --dims 3 --nx 1024 --ny 1024 --nz 1024 --output_folder mag3D_compression_test --save_TKE false --save_netcdf false
...
#python3 -u sz_test.py --metric mre --channels 1 --file mixing3D_compressiontest.h5 --start_value 0.001 --end_value 0.01 --value_skip .002 --dims 3 --nx 512 --ny 512 --nz 512 --output_folder mixing3D_compression --save_netcdf true
