...
python3 mixedLOD_octree.py --downscaling_technique avgpool3D --upscaling_technique model --distributed true --criterion psnr --start_metric 20 --end_metric 100 --metric_skip 5 --output_folder mix3D_1010_psnr_compression --mode 3D --file 1010.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --compressor sz --debug true
python3 mixedLOD_octree.py --downscaling_technique avgpool3D --upscaling_technique model --distributed true --criterion psnr --start_metric 20 --end_metric 100 --metric_skip 5 --output_folder mix3D_1010_psnr_compression --mode 3D --file 1010.h5 --dims 3 --nx 512 --ny 512 --nz 512 --use_compressor true --compressor fpzip --debug true
